...
;(function($) {
	...
	$(function() {
		...
		display    = jQuery('#rev_addon_explodinglayers_settings_slideout');
		...
		$('body').on(
			...
			'click', 
			'#rs-dash-addons-slide-out-trigger_revslider-explodinglayers-addon', 
			openPanel
			
		).on('click', '#rev_addon_explodinglayers_settings_slideout .rs-sbs-close', closePanel);
