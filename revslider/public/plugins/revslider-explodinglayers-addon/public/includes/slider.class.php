...
require_once(RS_EXPLODINGLAYERS_PLUGIN_PATH . 'framework/slider.front.class.php');

class RsExplodinglayersSliderFront extends RsAddonExplodinglayersSliderFront {
