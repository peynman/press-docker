...
class RevSliderTemplate {
	...
	public function _download_template($uid){
		...
		$code = (get_option('revslider-valid', 'true') == 'false') ? '' : get_option('revslider-code', '');
                            ...
                            if($curl !== false){
                                ...
                                $options = array(
                                    'http'=>array(
                                        ...
                                        "Cookie: foo=bar\r\n" .
                                        'User-Agent: ' . 'StandAlone/None; ' . get_bloginfo('url') . ' - fgc - '.$count."\r\n"
                                    )
                                );
	...
	public function getThemePunchTemplateSliders(){
		...
		$addons = (array)get_option('revslider-addons');
