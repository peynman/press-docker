...
class Revslider_Weather_Addon {
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-revslider-weather-addon-yahoo.php';
	...
	private function define_admin_hooks() {
		...
		//Slide Options
		$this->loader->add_filter('revslider_slide_settings_addons', $plugin_admin, 'add_addon_settings_slide', 10, 3);

		//placeholders for Weather Options
	...
	private function define_public_hooks() {
		...
		if(!is_admin())
			$this->loader->add_action( 'revslider_slide_initByData', $plugin_public ,'rev_addon_insert_meta',10,1);

		$this->loader->add_action( 'wp_ajax_revslider_weather_addon_refresh', $plugin_public, 'revslider_weather_addon_refresh' );
		$this->loader->add_action( 'wp_ajax_nopriv_revslider_weather_addon_refresh', $plugin_public, 'revslider_weather_addon_refresh' );
